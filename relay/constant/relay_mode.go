...
const (
	...
	RelayModeChatCompletions   //1
	RelayModeCompletions       //2
	RelayModeEmbeddings        //3
	RelayModeModerations       //4
	RelayModeImagesGenerations //5
	RelayModeEdits             //6

	RelayModeMidjourneyImagine              //7
	RelayModeMidjourneyDescribe             //8
	RelayModeMidjourneyBlend                //9
	RelayModeMidjourneyChange               //10
	RelayModeMidjourneySimpleChange         //11
	RelayModeMidjourneyNotify               //12
	RelayModeMidjourneyTaskFetch            //13
	RelayModeMidjourneyTaskImageSeed        //14
	RelayModeMidjourneyTaskFetchByCondition //15
